...
@HiltViewModel
class AddItineraryViewModel @Inject constructor(private val travelUseCase: TravelUseCase, private val userUseCase: UserUseCase) : ViewModel() {
    ...
    suspend fun insertTravel(travel: TravelEntity) {
        travelUseCase.insertTravel(travel)
    }
